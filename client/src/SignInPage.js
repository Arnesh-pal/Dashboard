        ...
        <div className="min-h-screen font-sans text-gray-800 bg-gray-50 flex">
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12">
                <div className="w-full max-w-md">
                    ...
                    <a href="https://my-dashboard-server-1cyf.onrender.com" className="w-full flex items-center justify-center py-3 px-4 border border-gray-200 rounded-xl shadow-sm text-md font-medium text-gray-700 bg-white hover:bg-gray-100 transition-all duration-300">
                        <GoogleIcon />
                        Sign in with Google
                    </a>
