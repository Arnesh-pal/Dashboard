        ...
        <>
            <div className="p-4 md:p-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div className="bg-[#DDEFE0] p-4 rounded-lg shadow">
                        <h3 className="text-sm">Total Revenues</h3>
                        <p className="text-2xl font-bold">₹{stats.totalRevenues.toLocaleString()}</p>
                    </div>
                    <div className="bg-[#F4ECDD] p-4 rounded-lg shadow">
                        <h3 className="text-sm">Total Transactions</h3>
                        <p className="text-2xl font-bold">{stats.totalTransactions.toLocaleString()}</p>
                    </div>
                    <div className="bg-[#DEE0EF] p-4 rounded-lg shadow">
